...
export class MapsPlayable {

    //table of maps available in the game
    #maps;
    //index of the played map
    #currentMap;
    //table of the maps names
    #mapsNames;

    constructor() {
        this.#mapsNames = ["Map Easy", "Map Medium", "Map Hard"];
        this.#currentMap = 0;
        this.#maps = [ 
    ...
    nextMap() {
        this.#currentMap++;
        let data = {};
        data.mapName = this.#mapsNames[this.#currentMap];
        data.layout = this.#maps[this.#currentMap];
        return data;
    }
